'use client';
import { WA_NUMBER, waLink } from '@/lib/utils';
import { useLang } from '@/i18n/LangProvider';
export default function WhatsAppFloat() {
  const { t } = useLang();
  return (
    <a href={waLink(WA_NUMBER, t.wa.msg)} target="_blank" rel="noreferrer" data-track="wa_click"
