...
export const banks = [
  ...
  { name: 'BSI', logo: 'https://logo.clearbit.com/bankbsi.co.id' },
  { name: 'Danamon', logo: 'https://logo.clearbit.com/danamon.co.id' },
  { name: 'Mandiri', logo: 'https://logo.clearbit.com/bankmandiri.co.id' },
  { name: 'Permata', logo: 'https://logo.clearbit.com/permatabank.com' },
  { name: 'UOB', logo: 'https://logo.clearbit.com/uob.co.id' },
